...
export const topic: LearningTopic = {
  ...
  description:
    "I've already shipped two AI-integrated products — a Gemini-powered assistant in production at Zebra Technologies and Ferris the Librarian, an offline RAG assistant I built end to end. This page tracks where I'm taking that further.",
  currentFocus: ["Agentic AI tools", "RAG architecture", "LangChain", "Model evaluation"],
  whatImDoing: [
    "Building on production experience with the Gemini LLM API from my internship at Zebra Technologies.",
